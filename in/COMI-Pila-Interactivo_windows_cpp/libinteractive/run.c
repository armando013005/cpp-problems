...
pipe_description pipe_descriptions[NUM_PIPES] = {
	{ "\\\\.\\pipe\\libinteractive_Main_PilaInteractivo_out", "\\\\.\\pipe\\libinteractive_PilaInteractivo_PilaInteractivo_out" },
	{ "\\\\.\\pipe\\libinteractive_PilaInteractivo_PilaInteractivo_in", "\\\\.\\pipe\\libinteractive_Main_PilaInteractivo_in" },
};

char* const commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"libinteractive\\PilaInteractivo\\PilaInteractivo.exe\"",
};
char* const debug_commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"gdbserver.exe\" \"127.0.0.1:8042\" \"libinteractive\\PilaInteractivo\\PilaInteractivo_debug.exe\" \"--print-ready\"",
};
