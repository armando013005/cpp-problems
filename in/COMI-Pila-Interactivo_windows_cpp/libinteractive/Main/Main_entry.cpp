...
void __NOINLINE __libinteractive_init() {
	openstream(&__PilaInteractivo_in, "\\\\.\\pipe\\libinteractive_Main_PilaInteractivo_in", O_WRONLY);
	openstream(&__PilaInteractivo_out, "\\\\.\\pipe\\libinteractive_Main_PilaInteractivo_out", O_RDONLY);
}
