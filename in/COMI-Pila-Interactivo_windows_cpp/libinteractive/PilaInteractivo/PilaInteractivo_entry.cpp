...
int main(int argc, char* argv[]) {
	...
	openstream(&__in, "\\\\.\\pipe\\libinteractive_PilaInteractivo_PilaInteractivo_in", O_RDONLY);
	openstream(&__out, "\\\\.\\pipe\\libinteractive_PilaInteractivo_PilaInteractivo_out", O_WRONLY);
