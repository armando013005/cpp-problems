...
pipe_description pipe_descriptions[NUM_PIPES] = {
	{ "\\\\.\\pipe\\libinteractive_Main_jarras_out", "\\\\.\\pipe\\libinteractive_jarras_jarras_out" },
	{ "\\\\.\\pipe\\libinteractive_jarras_jarras_in", "\\\\.\\pipe\\libinteractive_Main_jarras_in" },
};

char* const commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"libinteractive\\jarras\\jarras.exe\"",
};
char* const debug_commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"gdbserver.exe\" \"127.0.0.1:8042\" \"libinteractive\\jarras\\jarras_debug.exe\" \"--print-ready\"",
};
