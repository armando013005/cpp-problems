...
pipe_description pipe_descriptions[NUM_PIPES] = {
	{ "\\\\.\\pipe\\libinteractive_Main_tesoro_out", "\\\\.\\pipe\\libinteractive_tesoro_tesoro_out" },
	{ "\\\\.\\pipe\\libinteractive_tesoro_tesoro_in", "\\\\.\\pipe\\libinteractive_Main_tesoro_in" },
};

char* const commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"libinteractive\\tesoro\\tesoro.exe\"",
};
char* const debug_commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"gdbserver.exe\" \"127.0.0.1:8042\" \"libinteractive\\tesoro\\tesoro_debug.exe\" \"--print-ready\"",
};
